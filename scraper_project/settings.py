...
# raise error if env is not set properly
...
EMAIL_HOST_USER = get_env_without_exception('EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = get_env_without_exception('EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = get_env_without_exception('DEFAULT_FROM_EMAIL')
